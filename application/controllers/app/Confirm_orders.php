...
class Confirm_orders extends CI_Controller
{
	...
	public function index()
	{
		...
		$data["title"] = "Manage Confirmed Orders";

		$this->load->view("app/Confirm_orders/manage_orders", $data);
	}
