...
class Schedule_Notification extends CI_Controller
{
	/**
	...
	public function index()
	{
		...
		// $data["filter"] = '';
		// #----load view----------#
		$data["title"] = "Manage Schedule Notifications";
		$this->load->view("app/Schedule_Notification/manage", $data);
	}
	function show_app()
	{
		$user = $_POST['uid'];
	...
	public function add_notification()
	{
		...
		$this->load->view("app/Schedule_Notification/add", $data);
	}
	public function add()
	{
