...
class Dispatch_orders extends CI_Controller
{
	...
	public function index()
	{
		...
		$data["title"] = "Manage Dispatched Orders";

		$this->load->view("app/Dispatch_orders/manage_orders", $data);
	}
