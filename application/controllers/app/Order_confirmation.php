...
class Order_confirmation extends CI_Controller
{
	...
	public function index($order_id = '')
	{
		...
		$this->load->view("app/Order_confirmation/manage_orders", $data);
	}
