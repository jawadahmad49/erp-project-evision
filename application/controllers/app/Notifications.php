...
class Notifications extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view("app/Notifications/manage_notification", $data);
	}

	public function add_notification()
	{
		$data['promo_list'] = $this->db->query("SELECT * FROM `tbl_promo_code` where sts='Active'")->result_array();

		$this->load->view("app/Notifications/add_notification", $data);
	}
	...
	{ {
			...
			$data["filter"] = 'Notifications';
			#----load view----------#
			$data["title"] = "Notifications";

			$this->load->view("app/Notifications/add", $data);
		}
	}
	...
	public function edit($id)
	{
		if ($id) {
			...
			$where = "transid='$id'";
			$data['Notifications'] = $this->mod_common->select_single_records($table, $where);

			//pme($data['country']);

			$this->load->view("app/Notifications/edit", $data);
		}
	}
	...
	public function update()
	{
		if ($this->input->server('REQUEST_METHOD') == 'POST') {
			...
			if ($update) {
				...
				redirect(SURL . 'app/Notifications/');
			} else {
