...
class Invoice_wise_profit extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view($this->session->userdata('language')."/Invoice_wise_profit/search_report_item",$data);
	...
	{																			
		...
		$this->load->view($this->session->userdata('language')."/Invoice_wise_profit/detail_report",$data);
	}
