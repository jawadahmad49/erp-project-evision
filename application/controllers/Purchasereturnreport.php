...
class Purchasereturnreport extends CI_Controller {
	...
	public function __construct() {
        ...
        $this->load->model(array(
            "mod_purchasereturnreport","mod_common","mod_vendor","mod_salereturn"
        ));
	...
	public function index()
	{
		...
		$this->load->view($this->session->userdata('language')."/Purchasereturnreport/search",$data);
	}
	...
	public function details()
	{
		if($this->input->server('REQUEST_METHOD') == 'POST'){
			...
			$data['report']=  $this->mod_purchasereturnreport->get_details($this->input->post());
			//pm($data['report']); exit;
			...
			if ($data['report']) {
	            ...
	            //redirect(SURL . 'Purchasereturnreport/detail',$data);
	            $data["title"] = "Purchase Return Report";
	            $this->load->view($this->session->userdata('language')."/Purchasereturnreport/detail",$data);
	        } else {
	            $this->session->set_flashdata('err_message', 'No Record Found.');
	            redirect(SURL . 'Purchasereturnreport/');
	        }
	    }else{
	        //$data["filter"] = 'add';
	        $data["title"] = "Purchase Return Report";    			
	...
	public function detail($id){
		...
		#----load view----------#
		$data["title"] = "Purchase Return Report";
		$this->load->view($this->session->userdata('language')."/Purchasereturnreport/single",$data);
		}
	}
	...
	public function edit($id){
		if($id){
			...
			$this->load->view($this->session->userdata('language')."/Purchasereturnreport/add", $data);
		}
		/* Update Data */
		if($this->input->server('REQUEST_METHOD') == 'POST'){
