...
public function newconnection($databasename){
	...
	function shop_opening($mid, $type='',$to_date='',$closing='',$sale_point_id) {
			...
			$where_filled = array('materialcode' => $mid,'type =' => $type,'location ='=>$location);
...
//echo $new_filled; 
  ...
  // echo  $fromdate; echo "<br>"; echo  $todate; echo "<br>";
        ...
        if($query->num_rows()>0){
			...
			and tbl_goodsreceiving.trans_typ in('purchasefilled')
			and tbl_goodsreceiving.receiptdate > '$fromdate' and tbl_goodsreceiving.receiptdate < '$todate' and tbl_goodsreceiving.sale_point_id='$sale_point_id'";
			...
			where  tbl_goodsreceiving_detail.receipt_detail_id=tbl_goodsreceiving.receiptnos
			and tbl_goodsreceiving_detail.itemid='$itemid'
			and tbl_goodsreceiving.trans_typ='purchaseempty' and tbl_goodsreceiving.receiptdate > '$fromdate'
