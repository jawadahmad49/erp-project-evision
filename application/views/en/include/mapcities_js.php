...
function insert_data_per_row(callback){
    	...
    	$.ajax({ 
       	data: {date:date, customer:customer, remarks:remarks,kg_11_price:kg_11_price,item:item,qty1:qty1,return_qty1:return_qty1,item2:item2,qty2:qty2, return_qty2:return_qty2, item3:item3,qty3:qty3,return_qty3:return_qty3, amounttotal:total_amount,pay_mode:pay_mode,totalrecv:totalrecv,bank_code:bank_code,cheque_no:cheque_no,cheque_date:cheque_date,price1:price1,price2:price2,price3:price3,total_p1:total_p1,total_p2:total_p2,total_p3:total_p3},
       	type: "POST",
