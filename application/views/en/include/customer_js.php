...
function get_city_sp(loc){
	$.ajax({ 
       data: {loc_id:loc },
       type: "POST",
        url: "<?php echo SURL ?>sp/customer/get_city_sp",
       cache:false,
        dataType: "html",
...
function get_area_list(city_id){
	$.ajax({ 
       ...
       type: "POST",
        url: "<?php echo SURL ?>sp/customer/get_area",
       cache:false,
        dataType: "html",
       success: function(response) { 
       	alert(response);
		...
		<script src="<?php echo SURL; ?>assets/js/markdown.min.js"></script>
		<script src="<?php echo SURL; ?>assets/js/bootstrap-markdown.min.js"></script>
		<script src="<?php echo SURL; ?>assets/js/jquery.hotkeys.index.min.js"></script>
