...
//console.log();return false;
	...
	if(typess=='Filled'){
	var totalstock = parseInt(qty_val)+parseInt(emptystock_val);
...
function delete_row(no)
{
    ...
    if(table_len==0){
    	...
    	window.location.replace('<?php echo SURL."Purchase_return_filled/" ?>');

    	var deleteid = $('#edit_id').val();
    	var parentid =  document.getElementById("id").value;
    	var request = $.ajax({
			url: "<?php echo SURL ?>/Purchase_return_filled/trans_delete",
			type: "POST",
...
{
	var request = $.ajax({
	  url: "<?php echo SURL ?>Purchase_return_filled/record_delete",
	  type: "POST",
...
$('#data_table1 > #data_table2  > tr').each(function() {
	...
	//alert(date);return false;
		...
		request.done(function(msg) {
			...
			$("#emptystock_text"+row_number).val(empty_filled[0]);
...
function itemchange(itemid,no){
	...
	//alert(date);return false;
		...
		request.done(function(msg) {
		   ...
		   $("#emptystock_text"+no).val(empty_filled[0]);
