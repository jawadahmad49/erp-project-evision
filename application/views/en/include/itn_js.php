...
//var filledstock = parseInt(filledstock)-parseInt(qty);
    ...
    var row = table.insertRow(table_len).outerHTML="<tr id='row"+table_len+"'><td style='display:none;' id='"+item+"' class='"+type+"'>"+security_disable+"</td><td id='item_row"+table_len+"' style='width:15% !important;'><select class='form-control disable' name='item[]' id='item_"+table_len+"' data-placeholder='Choose a Item...' required='required' disabled onchange='itemchange(this.value,"+table_len+")'><?php 
    				...
    				?></select></td>	<td class='hidden-480'  style='width:9% !important;'><select disabled='disabled' class='form-control disable' name='type[]' id='type_"+table_len+"'><option value='Filled'>Filled</option><option value='Empty'>Empty</option></select></td>	<td id='qty_row"+table_len+"'><input type='text' id='qty_text"+table_len+"' readonly value='"+qty+"' name='qty[]'></td><td id='gasamt_row"+table_len+"'><input type='text' id='gasamt_text"+table_len+"' readonly  readonly value='"+gasamt+"' name='gasamt[]'></td>	<td id='security_row"+table_len+"'><input type='text' id='security_text"+table_len+"' readonly  value='"+security+"' name='security[]'></td>	<td class='hidden-480'   id='amounttotal_row"+table_len+"'><input type='text' id='amounttotal_text"+table_len+"' readonly  value='"+amounttotal+"' name='amounttotal[]'></td>	<td style='display: inline-flex; border: 0px;'><input type='button' id='edit_button"+table_len+"' value='Edit' class='btn btn-xs btn-success' onclick='edit_row("+table_len+")'> <input type='button' id='save_button"+table_len+"' value='Save' class='btn btn-xs btn-warning' onclick='savechecking("+table_len+")' style='display:none'> <input type='button' value='Delete' class='btn btn-xs btn-danger' onclick='delete_row("+table_len+")'></td></tr>";
...
//var filledstock = parseInt(filledstock)-parseInt(qty);
    ...
    var row = table.insertRow(table_len).outerHTML="<tr id='row"+table_len+"'><td style='display:none;' id='"+item+"' class='"+type+"'></td><td id='item_row"+table_len+"' style='width:15% !important;'><select class='form-control disable' name='item[]' id='item_"+table_len+"' data-placeholder='Choose a Item...' required='required' disabled onchange='itemchange(this.value,"+table_len+")'><?php 
    				...
    				?></select></td>	<td id='qty_row"+table_len+"'><input type='text' id='qty_text"+table_len+"' readonly value='"+qty+"' name='qty[]'></td><td id='gasamt_row"+table_len+"'><input type='text' id='gasamt_text"+table_len+"' readonly  readonly value='"+gasamt+"' name='gasamt[]'></td>					<td id='amounttotal_row"+table_len+"'><input type='text' id='amounttotal_text"+table_len+"' readonly  value='"+amounttotal+"' name='amounttotal[]'></td>	<td style='display: inline-flex; border: 0px;'><input type='button' id='edit_button"+table_len+"' value='Edit' class='btn btn-xs btn-success' onclick='edit_row_without("+table_len+")'> <input type='button' id='save_button"+table_len+"' value='Save' class='btn btn-xs btn-warning' onclick='savechecking_without("+table_len+")' style='display:none'> <input type='button' value='Delete' class='btn btn-xs btn-danger' onclick='delete_row("+table_len+")'></td></tr>";
...
if (isNaN(qty) || isNaN(gasamt) || isNaN(security_text)) {
		//$("#item").prop('required',true);
		//$("#qty").prop('required',true);
...
} else if (qty=='' || gasamt=='' || security_text=='') {
		//$("#item").prop('required',true);
		//$("#qty").prop('required',true);
		//$("#price").prop('required',true);
		//$("#addremove").prop('onclick',null);
...
function enable_disable(val){
	...
	if(val=='Empty'){
		document.getElementById('amounttotal').value-=document.getElementById('gasamt').value; 
		document.getElementById('gasamt').value=0; 
		document.getElementById('gasamt').disabled=true; 
	}
	else{
 ...
 $('#itn-item').on('change', function() {

	var item_id= $(this).val();
	var to= $('#location-to').val();
	//var from = $('#location-from').val();
	if(item_id=='' || to =='')
	{
	...
	var request = $.ajax({
	  ...
	  type: "POST",
	  data: {item_id:item_id,customer:customer},
	  dataType: "html"
	});
	request.done(function(msg) {
		var array=msg.split('|');
