...
function delete_row(no)
{
    ...
    if(table_len==0){
    	...
    	window.location.replace('<?php echo SURL."Swap_cylinder_receive/" ?>');
    }
...
{
	var request = $.ajax({
	  url: "<?php echo SURL ?>/Swap_cylinder_receive/record_delete",
	  type: "POST",
