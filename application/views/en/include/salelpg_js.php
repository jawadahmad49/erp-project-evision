...
if(vendor=='0' || vendor=='' || vendor=='0.00'){
	...
	$("#type").focus();
	return false;
}else if (security>0 && type=='refill') {
	alert("Please Select Type Sale / Security / Without Security!");
	$("#type").focus();
	return false;
}else if (item>8 && type!='sale') {
	alert("Please Select Type Sale !");
	$("#type").focus();
	return false;
}else { 
		document.getElementById("addremove").removeAttribute("type");
...
function savechecking(no){
 ...
 if (qty=='' || qty==0 || isNaN(qty)) {
	...
	$("#type_"+no).focus();
	return false;
}else if (security_text>0 && type=='refill') {
	alert("Please Select Type Sale / Security / Without Security!");
	$("#type").focus();
	return false;
}  else { 
