			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs" style="font-weight: bold;">
					<ul class="breadcrumb">
						...
						<li class="active">Manage Today Order <?php if ($arabic_check == 'Yes') { ?>(إدارة العنصر
							)<?php } ?></li>
					</ul><!-- /.breadcrumb -->
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<h3 class="header smaller lighter blue">Manage Today Order <?php if ($arabic_check == 'Yes') { ?>(إدارة العنصر
										)<?php } ?> </h3>
									...
									?>
									<form role="form" method="post" action="<?php echo SURL . "app/Order_dispatch/filter" ?>" style="background-color:#fafafa;">
										...
										<div class="form-group">
											...
											<div class="col-sm-2">
												<div class="input-group">
													<input name="to" class="form-control date-picker form_date" id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" required="" value="<?php echo date('Y-m-d'); ?>">
													<span class="input-group-addon">
														<i class="fa fa-calendar bigger-110"></i>
													</span>
												</div>
									...
									<div class="table-header" style="font-weight: bold;">
										Results for "Today Orders" <?php if ($arabic_check == 'Yes') { ?>(نتائج "العناصر")<?php } ?>
									</div>
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="btn btn-info btn-sm" class="" title="Print Invoice" href="<?php echo SURL . "app/Order_dispatch/detail_invoice/$issuenos" ?>">
																	Veiw Detail
																</a>
																<!-- <a class="btn btn-info btn-sm" class="" title="Print Invoice" href="<?php echo SURL . "app/Order_dispatch/pdffile/$issuenos" ?>">
																	Generate Invioce
																</a> -->
															</div>
														</td>
