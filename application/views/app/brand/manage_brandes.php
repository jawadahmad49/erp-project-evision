								...
								<div class="col-xs-12">
									...
									<div class="clearfix">
										...
										<div class="pull-right tableTools-container">
											<a href="<?php echo SURL ?>app/brand/add_brand">
										...
										<table id="dynamic-table" class="table table-striped table-bordered table-hover">
											<thead>
												<tr>
													...
													<th>Name</th>
													<th>Swap % (New/Good Condition)</th>
													<th>Swap % (Average Condition)</th>

													<th style="display: none;" class="hidden-480">Status</th>
											...
											for ($i = 0; $i < count($brand_list); $i++) { ?>
												...
												<tr>
													...
													<td>
														<?php echo $brand_list[$i]['brand_name']; ?>
													</td>
													<td>
														<?php echo $brand_list[$i]['swap_good']; ?>
													</td>
													<td>
														<?php echo $brand_list[$i]['swap_average']; ?>
													</td>


													<td style="display: none;" class="hidden-480">
														<?php echo $brand_list[$i]['status']; ?>
													</td>
													...
													<td>
														<div class="hidden-sm hidden-xs action-buttons">
															...
															<a class="green" href="<?php echo SURL . "app/brand/edit/" . $brand_list[$i]['brand_id'] ?>">
																<i class="ace-icon fa fa-pencil bigger-130"></i>
															</a>

															<a id="bootbox-confirm" href="javascript:void(0)" class="red" onClick="confirmDelete('<?php echo SURL; ?>app/brand/delete/<?php echo $brand_list[$i]['brand_id']; ?>');">
