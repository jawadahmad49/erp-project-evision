			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active bolder">Push Notification</li>
					</ul><!-- /.breadcrumb -->
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<h3 class="header smaller  blue"><?php echo $title;  ?></h3>
									...
									<div class="clearfix">
										...
										<div class="pull-right tableTools-container">
											<a href="<?php echo SURL ?>app/Push_notification/add">
									...
									<div>
										<table id="dynamic-table" class="table table-striped table-bordered table-hover">
											...
											<?php $count = 0;
											foreach ($push_notification as $key => $value) {
												$notification_id = $value['notification_id'];
												$title = $this->db->query("SELECT * FROM `tbl_notifications` where transid='$notification_id'")->row_array()['title'];

												$users_list = $this->db->query("SELECT user_id FROM `tbl_push_notification` where notification_id='$notification_id'")->result_array();
												$names = array();

												foreach ($users_list as $key => $val) {
													$user = $this->db->query("SELECT * FROM `tbl_user` where phone='" . $val['user_id'] . "'")->row_array();
													$name = $user['name'];
													$names[] = $name;
												}
												$user_names = implode(", ", $names);
												$count++;
											?>
												...
												<tr>
													...
													<td>
														<?php if ($value['status'] == 'Ended') {  ?>
															<font class="red bolder">Notification Expire</font>
														<?php } else { ?>
															<a class="green" href="<?php echo SURL . "app/Push_notification/edit/" . $value['id'] ?>">
