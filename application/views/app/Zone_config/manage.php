	...
	<div class="main-container ace-save-state" id="main-container">
		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs" style="background-color: #5baa4f; font-weight: bold;">
					<ul class="breadcrumb">
						<li>
						...
						<li class="active" style="color: white;">Manage Zone <?php if ($arabic_check == 'Yes') { ?>(إدارة العنصر
							)<?php } ?></li>
					</ul><!-- /.breadcrumb -->
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<h3 class="header smaller lighter blue">Manage Zone <?php if ($arabic_check == 'Yes') { ?>(إدارة العنصر
										)<?php } ?> </h3>
									...
									<div class="clearfix" style="margin-top: 10px;">
										...
										<div class="pull-right tableTools-container">
											...
											<a href="<?php echo SURL ?>app/Zone_config/add_sale_point">
									...
									<div class="table-header" style="background-color: #5baa4f; font-weight: bold;">
										Results for "Zone" <?php if ($arabic_check == 'Yes') { ?>(نتائج "العناصر")<?php } ?>
									</div>
										...
										<table id="dynamic-table" class="table table-striped table-bordered table-hover">
											...
											<tbody>
												...
												foreach ($result as $key => $value) {
													...
													$check_user = $this->db->query("SELECT * from tbl_user INNER JOIN tbl_zone_detail ON tbl_zone_detail.id=tbl_user.area_id where zone_id='" . $value['id'] . "'")->row_array();
													$check_sales_point = $this->db->query("SELECT * from tbl_sales_point where FIND_IN_SET('" . $value['id'] . "', zone_id) > 0")->row_array();
												?>
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="<?php echo SURL . "app/Zone_config/edit/" . $value['id'] ?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a><a class="blue" href="<?php echo SURL . "app/Zone_config/preview/" . $value['id'] ?>">
																	<i class="ace-icon fa fa-eye bigger-130"></i>
																</a>
																<?php if (empty($check_user) && empty($check_sales_point)) { ?>

																	<a id="bootbox-confirm" href="javascript:void(0)" class="red" onClick="confirmDelete('<?php echo SURL; ?>app/Zone_config/delete/<?php echo $value['id']; ?>');">
