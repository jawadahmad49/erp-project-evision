...
<body>
	...
	<section class="main-pd-wrapper form-group" style="width: 400px; margin: auto">
		<div style="
				  ...
				  color: #4a4a4a;
				">
			<img src="<?php echo IMG . "gallery/" . $hosp_img ?>" width="200" height="150">
		...
		<table style="width: 100%; table-layout: fixed">
			<thead>
				<tr>
					...
					<th style="width: 50px;text-align: left; padding-right: 0;">Type</th>
		...
		<table style="width: 100%;
			...
			<thead>
				...
				<tr>
					...
					<td style="text-align: right;"><?php echo number_format($ttl_delivery_charge) ?></td>
				</tr>
				<tr>
				...
				<tr style="background: #fcbd024f;">
					<td>Grand Total </td>
					<td style="text-align: right;"><?php echo number_format($lpg_amount + $ttl_accessories + $ttl_security_charges + $ttl_delivery_charge + $ttl_gst + $ttl_swap_charges) ?></td>
				</tr>
			</thead>
