...
<body class="no-skin">
            ...
            <div class="main-content-inner">
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Replacement Order</li>
                    </ul><!-- /.breadcrumb -->
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <form id="formID" class="form-horizontal" role="form" method="post" action="<?php echo SURL; ?>app/Cylinder_replacement/submit" enctype="multipart/form-data">

                                <div class="col-md-12 form-group">
                                    <fieldset class="scheduler-border">
                                        <legend class="scheduler-border">Replacement Order Detail</legend>
                                        <div class="form-group">
                                            ...
                                            <label class="col-sm-2 control-label no-padding-right" for="form-field-1">Delivered Order </label>
                                            <div class="col-sm-4">
                                                <select required="required" class="form-control" name="order" id="order" data-placeholder="Choose an order..." onchange="get_customer(); fetchItemsByOrder(this.value)">
                                                </select>
                                                </select>
                                            </div>
                                ...
                                <div class="col-md-12 form-group">
                                    <fieldset class="scheduler-border">
                                        <legend class="scheduler-border">Customer / Replacement Order Info</legend>
                                        <div class="col-xs-8">
                                            ...
                                            <div class="col-xs-12 form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <textarea name="delivery_address" id="delivery_address" class="form-control" maxlength="250" style="resize: vertical;" readonly></textarea>
                                ...
                                <div class="row col-md-12">
                                    <div class="col-xs-12 col-sm-12 pricing-span-body" style="margin-left: 1%; display: flex;">
                                        ...
                                        <div class="pricing-span5" id="deliveredQtyContainer">
                                            <div class="widget-box pricing-box-small widget-color-blue2">
                                                <div class="widget-header">
                                                    <h6 class="widget-title smaller lighter">Delivered Quantity</h6>
                                                </div>
                                                <div class="widget-body">
                                                    <input type="text" class="form-control" id="delivered_qty" tabindex="-1" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="pricing-span3">
                                            <div class="widget-box pricing-box-small widget-color-blue2">
                                                <div class="widget-header">
                                                    <b>
                                                        <h6 class="widget-title smaller lighter" style="font-size: 10px;">Replaced Quantity <?php if ($arabic_check == 'Yes') { ?> (كمية)<?php } ?></h6>
                                                    </b>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        //     // Fetch vehicles
        //     $.ajax({
        //         url: '<?php echo SURL; ?>app/Cylinder_replacement/get_orders',
        //         type: 'POST',
        //         data: {
        ...
        function fetchItemsByOrder(order_id) {
            $.ajax({
                url: '<?php echo SURL; ?>app/Cylinder_replacement/fetch_items_by_order',
                type: 'POST',
                data: {
                    order_id: order_id
                },
                success: function(response) {
                    ...
                    items.forEach(function(item) {
                        itemOptions += '<option value="' + item.materialcode + '">' + item.itemname + '</option>';
                    });
                    $('#materialcode').html(itemOptions);
                    $('#materialcode').trigger("chosen:updated"); // Update chosen select
                },
                error: function(xhr, status, error) {
                    console.error('AJAX Error while fetching items:', status, error);
                }
            });
        }
        ...
        function get_customer() {
            var order = $('#order').val();
            $.ajax({
                url: '<?php echo SURL; ?>app/Cylinder_replacement/get_customer',
                type: 'POST',
                data: {
                    order: order
                },
                success: function(response) {
                    ...
                    $("#delivery_address").val(res[4]).prop("readonly", true); // Make readonly here
                    $("#previous_delivery_address").val(res[4]); // Store in hidden field
        ...
        function temp_product() {
            ...
            $.ajax({
                url: '<?php echo SURL; ?>app/Cylinder_replacement/temp_product',
                type: 'POST',
                data: {
        ...
        function del_row(id) {
            $.ajax({
                url: '<?php echo SURL; ?>app/Cylinder_replacement/del_row',
                type: 'POST',
                data: {
                    id: id,
                },
        ...
        function get_item_detail() {
            ...
            $.ajax({
                url: '<?php echo SURL; ?>app/Cylinder_replacement/get_item_detail',
                type: 'POST',
                data: {
                    materialcode: materialcode,
                    order: order,
        ...
        function get_swap_charges() {
            ...
            $.ajax({
                url: '<?php echo SURL; ?>app/Cylinder_replacement/get_swap_charges',
                type: 'POST',
                data: {
                    materialcode: materialcode,
                    order: order,
        ...
        function get_order_detail() {
            ...
            $.ajax({
                url: '<?php echo SURL; ?>app/Cylinder_replacement/get_order_detail',
                type: 'POST',
                data: {
                    order: order,
                    sale_point_id: sale_point_id,
