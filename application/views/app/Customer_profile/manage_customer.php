...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Manage Customer Profile</li>
					</ul><!-- /.breadcrumb -->
											...
											<tbody>
												...
												foreach ($customer_list as $key => $value) { ?>
													<tr>
														...
														<td><?= $value['status'] ?></td>
														<td>
															<a class="green" href="<?php echo SURL . "app/Customer_profile/edit/" . $value['id'] ?>">
																<i class="ace-icon fa fa-pencil bigger-130"></i>
															</a>

															<a id="bootbox-confirm" href="javascript:void(0)" class="red" onClick="confirmDelete('<?php echo SURL; ?>app/Customer_profile/delete/<?php echo $value['id']; ?>');">
	...
	<script>
		...
		function showmanage() {
			...
			// $.ajax({
			// 	url: "<?= SURL . "app/Customer_profile/your_ajax_endpoint"; ?>",
			// 	cache: false,
			// 	type: "POST",
			// 	data: {
