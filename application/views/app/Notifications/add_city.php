				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo SURL."promocode"; ?>">PromoCode List  </a>
							</li>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form id="formID" class="form-horizontal" role="form" method="post" action="<?php echo SURL."Promocode/add"?>" enctype="multipart/form-data">
								...
								<div class="form-group">
										...
										<div class="col-sm-9">
											<input maxlength="50" value="" type="text" id="pcode" name="pcode" placeholder="Promo code " class="col-xs-10 col-sm-5"  required="required" title="Only Letters Allowed"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<select required="required" class="form-control"  name="category" id="category" data-placeholder="Choose a Type...">
									...
									<div class="form-group brand" style="display: none;" >
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Percentage </label>
												...
												<div class="col-sm-9">
											<input maxlength="50" value="" type="text" id="brandname" name="brandname" placeholder="Enter Percentage " class="col-xs-10 col-sm-5" required="required" title="Only Letters Allowed"/>
										</div>
									...
									<div class="form-group amount" style="display: none;" >
										...
										<div class="col-sm-9">
											<input maxlength="50" value="" type="text" id="amount" name="amount" placeholder="Enter Amount " class="col-xs-10 col-sm-5"  required="required" title="Only Letters Allowed"/>
										</div>
									</div>
