								...
								<div class="col-xs-12">
									...
									<div class="clearfix">
										...
										<div class="pull-right tableTools-container">
											<a href="<?php echo SURL ?>app/Notifications/add_notification">
									...
									<div>
										<table id="dynamic-table" class="table table-striped table-bordered table-hover">
											...
											for ($i = 0; $i < count($notification_list); $i++) {   ?>
												<?php
												$id = $notification_list[$i]['promo_code'];
												$promo_code =  $this->db->query("SELECT promo_code FROM  tbl_promo_code where transid='$id' ")->row_array()['promo_code'];

												$notification_id = $notification_list[$i]['transid'];
												$Notifications =  $this->db->query("SELECT * FROM tbl_push_notification where notification_id='$notification_id' ")->row_array();
												$send_notification = 0;
													...
													<td>
														...
														<div class="hidden-sm hidden-xs action-buttons">
															<?php if ($notification_list[$i]['sts'] == 'Ended') {  ?>
																<font class="red bolder">Notifications Expire</font>
															<?php } elseif ($send_notification == 0) { ?>
																<a class="green" href="<?php echo SURL . "app/Notifications/edit/" . $notification_list[$i]['transid'] ?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>
																<a id="bootbox-confirm" href="javascript:void(0)" class="red" onClick="confirmDelete('<?php echo SURL; ?>app/Notifications/delete/<?php echo $notification_list[$i]['transid']; ?>');">
																	<i class="ace-icon fa fa-trash-o bigger-130"></i>
																</a>
															<?php } else { ?>
																<font class="green bolder">Notifications Send</font>
															<?php } ?>
														</div>
