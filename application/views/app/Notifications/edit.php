...
<?php $this->load->view('adm/sidebar');
		?>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo SURL."adm/notification"; ?>">Notification List  </a>
							</li>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form id="formID" class="form-horizontal" role="form" method="post" action="<?php echo SURL."adm/notification/update"?>" enctype="multipart/form-data">
								...
								<input type="hidden" name="clas" value="1">
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<select required="required" class="form-control" name="pcode" id="pcode" data-placeholder="Choose a Promo...">
													<option value="0">Notification Without Promo</option>
												...
												# code...
												?>
												<option value="<?php echo $data['transid']; ?>"<?php if($data['transid']==$notification['promo_code']){ ?> selected <?php } ?>><?php echo ucwords($data['promo_code']); ?></option>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input maxlength="10" value="<?php echo $notification['title'] ?>" type="text" id="title" name="title" placeholder="Enter Title" class="col-xs-10 col-sm-5"  required="required" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div id="targetLayer">
												...
												<img width="200" height="200" id="logo_id" src="<?php echo IMG .'notification/'.$notification['logo']; ?>">
												<?php } ?>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="start_date" class="form-control date-picker start_date" id="id-date-picker-1" type="text"  data-date-format="yyyy-mm-dd" data-date-start-date="0d" required="" value="<?php  echo $notification['start_date'] ?>">
                                            </div>
                                        </div>
                                    </div>
	<style type="text/css">
									  ...
									  <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="end_date" class="form-control date-picker end_date" id="id-date-picker-1" type="text"  data-date-format="yyyy-mm-dd" data-date-start-date="0d" required="" value="<?php echo $notification['expiry_date']  ?>">
                                            </div>
                                        </div>
...
<?php $this->load->view('en/include/item_js.php'); ?>
