				...
				<div class="page-content">
					...
					<div class="page-header">
						<h1>
							...
							<small>
								<i class="ace-icon fa fa-angle-double-right"></i>
								Remaining User Limmit&nbsp;<span style="color: red;"> (<?php echo $remaining_user; ?>)</span>
							</small>
						</h1>
					</div><!-- /.page-header -->
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form id="formID" class="form-horizontal" role="form" method="post" action="<?php echo SURL . "app/user/add" ?>" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input maxlength="50" value="" type="text" id="admin_name" name="admin_name" placeholder="User Name" class="col-xs-10 col-sm-5" pattern="^[a-zA-Z ]*$" required="required" title="Only Letters Allowed" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input maxlength="50" value="" type="text" id="loginid" name="loginid" placeholder="Login Id" class="col-xs-10 col-sm-5" required="required" title="Only Letters Allowed" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input maxlength="50" value="" type="text" id="email" name="email" placeholder="Email" class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input maxlength="50" value="" type="password" id="admin_pwd" name="admin_pwd" placeholder="Password" class="col-xs-10 col-sm-5" required="required" title="Only Letters Allowed" />
									</div>
								</div>
								<div class="form-group">
