								...
								<div class="col-xs-12">
									...
									<div class="clearfix">
										...
										<div class="pull-right tableTools-container">
											<a href="<?php echo SURL ?>app/item/add_item">
										...
										<table id="dynamic-table" class="table table-striped table-bordered table-hover">
											...
											for ($i = 0; $i < count($item_list); $i++) { ?>
												...
												<tr>
													...
													<td><?php echo $item_list[$i]['itemname']; ?></td>
													<td>
														<?php echo $item_list[$i]['catname']; ?>
													</td>
													<td>
														<?php echo $item_list[$i]['security_price']; ?>
													</td>


													<td style="display: none;"></td>

													<!-- <td><?php echo $item_list[$i]['classname']; ?></td> -->


													<td class="hidden-480">
														<?php echo $item_list[$i]['status']; ?>
													</td>
													...
													<td>
														<div class="hidden-sm hidden-xs action-buttons">
															...
															<a class="green" href="<?php echo SURL . "app/item/edit/" . $item_list[$i]['materialcode'] ?>">
																<i class="ace-icon fa fa-pencil bigger-130"></i>
															</a>

															<a id="bootbox-confirm" href="javascript:void(0)" class="red" onClick="confirmDelete('<?php echo SURL; ?>app/item/delete/<?php echo $item_list[$i]['materialcode']; ?>');">
																<i class="ace-icon fa fa-trash-o bigger-130"></i>
															</a>
															<?php if ($item_list[$i]['catcode'] == 2) { ?>
																<!-- <button onclick="location.href = '<?php echo SURL . "app/item/define_prices/" . $item_list[$i]['materialcode'] ?>'" class="btn btn-xs btn-info">
																	Define Prices
																</button> -->
															<?php } ?>
														</div>
