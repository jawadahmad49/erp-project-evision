					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								...
								?>
								<a href="<?php echo SURL."app/item/define_prices/".$id; ?>"><?php echo $item["itemname"];
							...
							<div class="col-xs-12">
								...
								<form id="formID" class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input maxlength="50" style="width: 244px;" value="<?php if(isset($_POST["itemname"])){ echo $_POST["itemname"]; }else{ echo $item["itemname"]; } ?>" type="text" id="itemname" name="itemname" placeholder="Item Name" pattern="[-+]?[0-9]*\.?[0-9]*" class="col-xs-12  col-sm-5 urdu_class" readonly  required="required" />
										</div>
									</div>
										...
										<div class="col-sm-3">
											<select required="required" class="form-control" name="city" id="city" data-placeholder="Choose a City...">
												...
												<?php foreach ($cities as $key => $value) {
													...
													if(isset($item_p["city"]) && $item_p["city"]==$value["city_id"]){ 
														echo "selected";
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input maxlength="20" style="width: 244px;" value="<?php
											if(isset($_POST["price"])){ echo $_POST["price"]; }else{ echo $item_p['sale_price']; } ?>" type="text" id="price" name="price" placeholder="Sale Price" pattern="[-+]?[0-9]*\.?[0-9]*" title="Numbers only" class="col-xs-12  col-sm-5 urdu_class"  required="required" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<div class="input-group">
												<input class="form-control date-picker"   id="id-date-picker-1" value="<?php if(isset($_POST["date"])){ echo $_POST["date"]; }else{ echo $item_p["effective_date"]; } ?>" data-date-start-date="0d" type="text" data-date-format="yyyy-mm-dd" required="" name="date">
									...
									<div class="row">
										...
										<hr/>
										<input type="hidden" name="sp_id" value="<?php if(isset($_POST["sp_id"])){ echo $_POST["sp_id"]; }else{ echo $item_p['itemcode']; } ?>">
...
?>
<?php $this->load->view('app/include/customer_edit_js.php'); ?>
