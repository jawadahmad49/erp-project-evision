			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs" style="background-color: #5baa4f; font-weight: bold;">
					<ul class="breadcrumb">
						...
						<li class="active" style="color: white;">Manage Users <?php if ($arabic_check == 'Yes') { ?>(إدارة العنصر
								)<?php } ?></li>
					</ul><!-- /.breadcrumb -->
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<h3 class="header smaller lighter blue">Manage Users <?php if ($arabic_check == 'Yes') { ?>(إدارة العنصر
											)<?php } ?> </h3>
									...
									<div class="clearfix">
										<div class="pull-right tableTools-container">
											<a href="<?php echo SURL ?>app/User_list/add_user">
											...
											<tbody>
												...
												foreach ($users as $key => $value) {
													...
													<tr>
														...
														<!--<td><?php echo base64_decode($value['admin_pwd']); ?></td> -->
														<td><?php echo $value['joining_date']; ?></td>

														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="green" href="<?php echo SURL; ?>app/User_list/edit/<?php echo $value['id']; ?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>
																<a id="bootbox-confirm" href="javascript:void(0)" class="red" onClick="confirmDelete(' <?php echo SURL; ?>app/User_list/delete/<?php echo $value['id']; ?>');">
...
<![endif]-->
	<script type="text/javascript">
		if (' ontouchstart' in document.documentElement) document.write("<script src='<?php echo SURL; ?>assets/js/jquery.mobile.custom.min.js'>" + "<" + "/script>"); </script>
