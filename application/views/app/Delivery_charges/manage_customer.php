								...
								<div class="col-xs-12">
									...
									<div class="clearfix">
										<div class="pull-right tableTools-container">
											<a href="<?php echo SURL ?>app/Delivery_charges/add_charges">
									...
									<div>
										...
										<table id="dynamic-table" class="table table-striped table-bordered table-hover">
											...
											for ($i = 0; $i < count($tbl_data); $i++) {
												...
												$zone_name = $this->db->query("SELECT zone_name FROM `tbl_zone` where id='" . $tbl_data[$i]['zone'] . "'")->row_array()['zone_name'];
												?>
												<tr>
													...
													<td>
														<?php echo $tbl_data[$i]['e_date']; ?>
													</td>
													<td>
														<?php echo $tbl_data[$i]['standard_range']; ?>
													</td>
													<td>
														<?php echo $tbl_data[$i]['express_range']; ?>
													</td>
													<td>
														<a class="green" href="<?php echo SURL . "app/Delivery_charges/edit/" . $id ?>">
															<i class="ace-icon fa fa-pencil bigger-130"></i>
														</a>
														<a id="bootbox-confirm" href="javascript:void(0)" class="red" onClick="confirmDelete('<?php echo SURL; ?>app/Delivery_charges/delete/<?php echo $tbl_data[$i]['id']; ?>');">
