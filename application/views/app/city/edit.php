				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form id="formID" class="form-horizontal" role="form" method="post" action="<?php echo SURL . "app/city/update" ?>" enctype="multipart/form-data">
									...
									<div class="col-sm-3">
										<select class="form-control" name="cid" id="cid" data-placeholder="Choose a Country...">
											...
											foreach ($country_list as $key => $data) {
												# code...
											?>
												<option value="<?php echo $data['country_id']; ?>" <?php if ($data['country_id'] == $city['country_id']) { ?> selected <?php } ?>><?php echo ucwords($data['country_name']); ?></option>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input maxlength="50" value="<?php echo $city['city_name'] ?>" type="text" id="cname" name="cname" placeholder="City Name" class="col-xs-10 col-sm-5" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" required="required" title="Only Letters Allowed" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-3">
										<select class="chosen-select form-control" name="status" id="status" data-placeholder="Choose a Status...">
											...
											<option value="Active" <?php if ($city['status'] == 'Active') { ?> selected <?php } ?>>Active</option>
											<option value="InActive" <?php if ($city['status'] == 'InActive') { ?> selected <?php } ?>>InActive</option>
