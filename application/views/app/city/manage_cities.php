								...
								<div class="col-xs-12">
									...
									<div class="clearfix">
										...
										<div class="pull-right tableTools-container">
											<a href="<?php echo SURL ?>app/city/add_city">
										...
										<table id="dynamic-table" class="table table-striped table-bordered table-hover">
											...
											for ($i = 0; $i < count($city_list); $i++) { ?>
												...
												<tr>
													...
													<td style="display: none;"><?php echo $city_list[$i]['country_name']; ?></td>


													<td class="hidden-480">
														<?php echo $city_list[$i]['status']; ?>
													</td>
													...
													<td>
														<div class="hidden-sm hidden-xs action-buttons">
															...
															<a class="green" href="<?php echo SURL . "app/city/edit/" . $city_list[$i]['city_id'] ?>">
																<i class="ace-icon fa fa-pencil bigger-130"></i>
															</a>

															<a id="bootbox-confirm" href="javascript:void(0)" class="red" onClick="confirmDelete('<?php echo SURL; ?>app/city/delete/<?php echo $city_list[$i]['city_id']; ?>');">
