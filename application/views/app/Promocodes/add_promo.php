				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form id="formID" class="form-horizontal" role="form" method="post" action="<?php echo SURL . "app/promocodes/add" ?>" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input maxlength="10" value="" type="text" id="pcode" name="pcode" placeholder="Promo code " class="col-xs-10 col-sm-5" required="required" title="Only Letters Allowed" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<select required="required" class="form-control chosen-select" name="category" id="category" onchange="promo_type()" data-placeholder="Choose a Type...">
								...
								<div class="form-group brand" style="display: none;">
									...
									<div class="col-sm-3">
										<input maxlength="10" onkeypress="return /[0-9 . ]/i.test(event.key)" style="width: 100%;" type="text" id="brandname" name="brandname" placeholder="Enter Percentage " required="required" title="Only Letters Allowed" />
									</div>
								...
								<div class="form-group amount" style="display: none;">
									...
									<div class="col-sm-3">
										<input maxlength="10" onkeypress="return /[0-9 . ]/i.test(event.key)" style="width: 100%;" type="text" id="amount" name="amount" placeholder="Enter Amount " required="required" title="Only Letters Allowed" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										...
										<div class="input-group">
											...
											<input name="start_date" class="form-control date-picker start_date" readonly id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" data-date-start-date="0d" required="" value="<?php echo date('Y-m-d'); ?>">
										</div>
									</div>
								</div>
								<style type="text/css">
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										...
										<div class="input-group">
											...
											<input name="end_date" class="form-control date-picker end_date" id="id-date-picker-2" readonly type="text" data-date-format="yyyy-mm-dd" data-date-start-date="0d" required="" value="<?php echo date('Y-m-d'); ?>">
										</div>
									</div>
