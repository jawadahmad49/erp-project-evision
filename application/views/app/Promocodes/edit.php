			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li>
							<a href="<?php echo SURL . "app/promocodes"; ?>">PromoCode List </a>
						</li>
						<li class="active">Update PromoCode </li>
					</ul><!-- /.breadcrumb -->
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form id="formID" class="form-horizontal" role="form" method="post" action="<?php echo SURL . "app/promocodes/update" ?>" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input maxlength="10" value="<?php echo $promo['promo_code'] ?>" type="text" id="pcode" name="pcode" placeholder="Promo code " class="col-xs-10 col-sm-5" required="required" title="Only Letters Allowed" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<select required="required" class="form-control chosen-select" name="category" onchange="promo_type()" id="category" data-placeholder="Choose a Type...">
											<option value=""> Select Type First... </option>
											<option value="Percentage" <?php if ($promo['discount_type'] == 'Percentage') { ?> selected <?php } ?>>Percentage</option>
											<option value="Amount" <?php if ($promo['discount_type'] == 'Amount') { ?> selected <?php } ?>>Amount</option>
										</select>
									</div>
								</div>
								...
								<div class="form-group brand" style="display: none;">
									...
									<div class="col-sm-3">
										<input maxlength="10" value="<?php echo $promo['discount_percentage'] ?>" type="text" id="brandname" name="brandname" placeholder="Enter Percentage " style="width: 100%;" required="required" title="Only Letters Allowed" />
									</div>
								...
								<div class="form-group amount" style="display: none;">
									...
									<div class="col-sm-3">
										<input maxlength="10" value="<?php echo $promo['discount_amount'] ?>" type="text" id="amount" name="amount" placeholder="Enter Amount " style="width: 100%;" required="required" title="Only Letters Allowed" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										...
										<div class="input-group">
											...
											<input name="start_date" class="form-control date-picker start_date" readonly id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" data-date-start-date="0d" required="" value="<?php echo $promo['start_date'] ?>">
										</div>
									</div>
								</div>
								<style type="text/css">
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										...
										<div class="input-group">
											...
											<input name="end_date" class="form-control date-picker end_date" readonly id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" data-date-start-date="0d" required="" value="<?php echo $promo['expiry_date']  ?>">
										</div>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<select class="chosen-select form-control" name="status" id="status" data-placeholder="Choose a Status...">
											...
											<option value="Active" <?php if ($promo['sts'] == 'Active') { ?> selected <?php } ?>>Active</option>
											<option value="InActive" <?php if ($promo['sts'] == 'InActive') { ?> selected <?php } ?>>InActive</option>
								...
								<input type="hidden" name="id" value="<?php echo $promo['transid'] ?>" />
							</form>
