			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Manage Promo Codes</li>
					</ul><!-- /.breadcrumb -->
								...
								<div class="col-xs-12">
									...
									<div class="clearfix">
										...
										<div class="pull-right tableTools-container">
											<a href="<?php echo SURL ?>app/Promocodes/add_promo">
									...
									<div>
										<table id="dynamic-table" class="table table-striped table-bordered table-hover">
											...
											<?php $count = 1;
											for ($i = 0; $i < count($promo_list); $i++) {   ?>


												<tr>

													<td>
														<?php echo  $promo_list[$i]['promo_code']; ?>
													</td>


													<td><?php echo  $promo_list[$i]['sts']; ?></td>


													<td>
														<?php echo  $promo_list[$i]['discount_amount']; ?>
													</td>
													<td><?php echo  $promo_list[$i]['discount_percentage']; ?></td>
													<td><?php echo  $promo_list[$i]['discount_type']; ?></td>
													<td><?php echo  $promo_list[$i]['start_date']; ?></td>
													<td><?php echo  $promo_list[$i]['expiry_date']; ?></td>


													<td>
														<?php

														$promo = $promo_list[$i]['transid'];



														$rows = $this->db->query("SELECT * FROM tbl_notifications where promo_code='$promo' ")->row_array();
														?>
														<div class="hidden-sm hidden-xs action-buttons">
															<?php if ($promo_list[$i]['sts'] == 'Ended') {  ?>
																<font class="red bolder">Promo Code Expire</font>
															<?php } elseif ($rows == 0) { ?>
																<a class="green" href="<?php echo SURL . "app/Promocodes/edit/" . $promo_list[$i]['transid'] ?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a id="bootbox-confirm" href="javascript:void(0)" class="red" onClick="confirmDelete('<?php echo SURL; ?>app/Promocodes/delete/<?php echo $promo_list[$i]['promo_code']; ?>');">
																	<i class="ace-icon fa fa-trash-o bigger-130"></i>
																</a>

															<?php } else { ?>
																<font class="green bolder">Promo Used</font>
															<?php } ?>
