									...
									<div class="col-xs-12">
										...
										<div class="clearfix">
											<div class="pull-right tableTools-container">
												<a href="<?php echo SURL?>app/Gazzetted_holidays/add_gazzetted_holiday">
										...
										<div class="table-header">
											Results for "Holidays Configuration"
										</div>
										...
										<?php $count=1;  for ($i=0; $i <count($holiday_list) ; $i++) {   ?>
													<tr>

														<td>
															<?php echo  $holiday_list[$i]['holiday_code']; ?>
														</td>
														 <td>
														 	<?php echo  $holiday_list[$i]['holiday_name']; ?>
														 </td>
														 <td>
														 	<?php echo  $holiday_list[$i]['from_date']; ?>
														 </td>
														 <td>
														 	<?php echo  $holiday_list[$i]['to_date']; ?>
														 </td>
														 <td>
														 	<?php echo  $holiday_list[$i]['duration']; ?>
														 </td>
														  <td>
														 	<?php echo  $holiday_list[$i]['repeats_annualy']; ?>
														 </td>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="<?php echo SURL."app/Gazzetted_holidays/edit/".$holiday_list[$i]['holiday_code']?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a id="bootbox-confirm" href="javascript:void(0)" class="red" onClick="confirmDelete('<?php echo SURL; ?>app/Gazzetted_holidays/delete/<?php echo $holiday_list[$i]['holiday_code'];?>');">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a  href="<?php echo SURL."app/Gazzetted_holidays/edit/".$holiday_list[$i]['holiday_code']?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
																		...
																		<li>
																			<a onClick="confirmDelete('<?php echo SURL; ?>app/Gazzetted_holidays/delete/<?php echo $holiday_list[$i]['holiday_code'];?>');" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
