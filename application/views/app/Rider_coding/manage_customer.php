			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Delivery Charges<?php if ($arabic_check == 'Yes') { ?>(إدارة العملاء)<?php } ?></li>
					</ul><!-- /.breadcrumb -->
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<h3 class="header smaller lighter blue"><?php echo $title; ?> <?php if ($arabic_check == 'Yes') { ?>(إدارة العملاء)<?php } ?></h3>
									...
									<div class="clearfix">
										<div class="pull-right tableTools-container">
											<a href="<?php echo SURL ?>app/Rider_coding/add_rider">
									...
									<div class="table-header">
										Results for "Delivery Charges" <?php if ($arabic_check == 'Yes') { ?>(نتائج "العملاء")<?php } ?>
									</div>
									<div>
										...
										<table id="dynamic-table" class="table table-striped table-bordered table-hover">
											...
											for ($i = 0; $i < count($tbl_data); $i++) {
												$id = $tbl_data[$i]['id'];
												$sp_name = $this->db->query("SELECT * FROM `tbl_sales_point` where sale_point_id='" . $tbl_data[$i]['sale_point_id'] . "'")->row_array()['sp_name'];
												?>
												<tr>
													<td>
														<?php echo $b; ?>
													...
													<td>
														<?php echo $tbl_data[$i]['rider_name']; ?>
													</td>
													<td>
														<?php echo $tbl_data[$i]['phone_number']; ?>
													</td>
													<td>
														<?php echo $tbl_data[$i]['cnic']; ?>
													</td>
													<td>
														<?php echo $tbl_data[$i]['date']; ?>
													</td>
													<td>
														<?php echo $tbl_data[$i]['loginid']; ?>
													</td>
													<td>
														<?php echo base64_decode($tbl_data[$i]['password']); ?>
													</td>
													<td>
														<a class="green" href="<?php echo SURL . "app/Rider_coding/edit/" . $id ?>">
															<i class="ace-icon fa fa-pencil bigger-130"></i>
														</a>
														<?php if ($tbl_data[$i]['status'] != 'Allocated') { ?>
															<a id="bootbox-confirm" href="javascript:void(0)" class="red" onClick="confirmDelete('<?php echo SURL; ?>app/Rider_coding/delete/<?php echo $tbl_data[$i]['id']; ?>');">
																<i class="ace-icon fa fa-trash-o bigger-130"></i>
															</a>
														<?php } else { ?>
															<span class="red bolder">Rider Is Allocated To A Trip</span>
														<?php } ?>
