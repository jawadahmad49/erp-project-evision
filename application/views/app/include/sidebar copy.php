	...
	<ul class="nav nav-list">
		<ul class="nav nav-list">
			...
			for ($i = 0; $i < count($result); $i++) {
				...
				if ($result[$i]['pageid'] > 1040 && $result[$i]['pageid'] < 1065) {
					$flag = 1; ?>
					<?php if ($new_jj++ == 0) { ?>
						<li class="">
				...
				for ($i = 0; $i < count($result); $i++) {
					...
					if ($result[$i]['pageid'] > 1071 && $result[$i]['pageid'] < 1085) {
						$flag = 1; ?>
							<?php if ($new_jj++ == 0) { ?>
								<li class="">
						...
						for ($i = 0; $i < count($result); $i++) {
							...
							if ($result[$i]['pageid'] > 1085 && $result[$i]['pageid'] < 1095) {
								$flag = 1; ?>
									<?php if ($new_jj++ == 0) { ?>
										<li class="">

											<a href="#" class="dropdown-toggle">
												<i id="icons1" class="menu-icon fa fa-light fa-bell"></i>
												<span class="menu-text">
													Notifications
												</span>
