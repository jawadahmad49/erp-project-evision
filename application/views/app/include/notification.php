			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Manage Booked Orders</li>
					</ul><!-- /.breadcrumb -->
								...
								<div class="col-xs-12">
									...
									<div>
										...
										<table id="dynamic-table" class="table table-striped table-bordered table-hover">
											...
											<tbody>
												<?php $count = 0;
												foreach ($booked_orders as $key => $value) {
													$count++;
													$userid = $value['userid'];
												...
												?>
													<tr>
														...
														<td><strong class="red"><?php echo $value['deliveryStatus'] ?></strong></td>
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="btn btn-info btn-xs" target="blank" title="Print Invoice" href="<?php echo SURL . 'app/Order_confirmation/index/' . $value['id'] ?>">
																	Action
																</a>
															</div>
														</td>
