				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form id="formID" class="form-horizontal" role="form" method="post" action="<?php echo SURL . "app/category/add" ?>" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input maxlength="50" value="" type="text" id="catname" name="catname" placeholder="Category Name" class="col-xs-12 col-sm-5" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" required="required" autofocus />
									</div>
								</div>
								<div class="form-group">
