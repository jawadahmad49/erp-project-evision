								...
								<div class="col-xs-12">
									...
									<div class="clearfix">
										...
										<div class="pull-right tableTools-container">
											<a href="<?php echo SURL ?>app/category/add_category">
											...
											<tbody>
												...
												for ($i = 0; $i < count($category_list); $i++) { ?>
													...
													<tr>
														...
														<td>
															<?php echo $category_list[$i]['catname']; ?>
														</td>


														<td style="display: none;"><?php echo $category_list[$i]['classname']; ?></td>


														<td class="hidden-480">
															<?php echo $category_list[$i]['status']; ?>
														</td>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<?php
																$cat_id = $category_list[$i]['id'];
																$catcode = $this->db->query("Select catcode from tblmaterial_coding where catcode = '$cat_id'")->row_array();
																if ($catcode) {
																	continue;
																} ?>
																<a class="green" href="<?php echo SURL . "app/category/edit/" . $category_list[$i]['id'] ?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a id="bootbox-confirm" href="javascript:void(0)" class="red" onClick="confirmDelete('<?php echo SURL; ?>app/category/delete/<?php echo $category_list[$i]['id']; ?>');">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="<?php echo SURL . "app/category/edit/" . $category_list[$i]['id'] ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
																		...
																		<li>
																			<a onClick="confirmDelete('<?php echo SURL; ?>category/delete/<?php echo $category_list[$i]['id']; ?>');" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
