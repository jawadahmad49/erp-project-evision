			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Manage Slider Configuration</li>
					</ul><!-- /.breadcrumb -->
								...
								<div class="col-xs-12">
									...
									<div class="clearfix">
										<div class="pull-right tableTools-container">
											<a href="<?php echo SURL ?>app/Slider_config/add_shifts">
									...
									<div class="table-header">
										Results for "Slider Configuration"
									</div>
												...
												<tr>
													...
													<td>
														<div class="hidden-sm hidden-xs action-buttons">
															<a class="green" href="<?php echo SURL . "app/Slider_config/edit/" . $value['id'] ?>">
																<i class="ace-icon fa fa-pencil bigger-130"></i>
															</a>

															<a id="bootbox-confirm" href="javascript:void(0)" class="red" onClick="confirmDelete('<?php echo SURL; ?>app/Slider_config/delete/<?php echo $value['id']; ?>');">
