			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs" style="background-color: #5baa4f; font-weight: bold;">
					<ul class="breadcrumb">
						...
						<li class="active" style="color: white;">Manage SALE POINTS <?php if ($arabic_check == 'Yes') { ?>(إدارة العنصر
							)<?php } ?></li>
					</ul><!-- /.breadcrumb -->
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<h3 class="header smaller lighter blue">Manage SALE POINTS <?php if ($arabic_check == 'Yes') { ?>(إدارة العنصر
										)<?php } ?> </h3>
									...
									<div class="clearfix" style="margin-top: 10px;">
										...
										<div class="pull-right tableTools-container">
											...
											<a href="<?php echo SURL ?>app/Sale_point_coding/add_sale_point">
									...
									<div class="table-header" style="background-color: #5baa4f; font-weight: bold;">
										Results for "SALE POINTS" <?php if ($arabic_check == 'Yes') { ?>(نتائج "العناصر")<?php } ?>
									</div>
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="<?php echo SURL . "app/Sale_point_coding/edit/" . $value['sale_point_id'] ?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<!-- <a id="bootbox-confirm" href="javascript:void(0)" class="red" onClick="confirmDelete('<?php echo SURL; ?>app/Sale_point_coding/delete/<?php echo $value['sale_point_id']; ?>');">
