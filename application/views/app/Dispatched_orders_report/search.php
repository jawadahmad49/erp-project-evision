				...
				<div class="page-content">
					...
					<div class="row">
						...
						<div class="col-xs-12">
							...
							<form id="formID" target="blank_" class="form-horizontal" role="form" method="post" action="<?php echo SURL; ?>app/Dispatched_orders_report/details" enctype="multipart/form-data">
