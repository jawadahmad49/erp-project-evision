			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Vehicle Coding<?php if ($arabic_check == 'Yes') { ?>(إدارة العملاء)<?php } ?></li>
					</ul><!-- /.breadcrumb -->
								...
								<div class="col-xs-12">
									...
									<div class="clearfix">
										<div class="pull-right tableTools-container">
											<a href="<?php echo SURL ?>app/Vehicle_coding/add_vehicle">
									...
									<div class="table-header">
										Results for "Vehicle Coding" <?php if ($arabic_check == 'Yes') { ?>(نتائج "العملاء")<?php } ?>
									</div>
									<div>
										...
										<table id="dynamic-table" class="table table-striped table-bordered table-hover">
											...
											?>
												<tr>
													...
													<td>
														<?php echo $tbl_data[$i]['vehicle_type']; ?>
													</td>
													<td>
														<?php echo $tbl_data[$i]['vehicle_number']; ?>
													</td>
													<td>
														<?php echo $tbl_data[$i]['registration_date']; ?>
													</td>
													<td>
														<?php echo $tbl_data[$i]['status']; ?>
													</td>
													<td>
														<?php if ($tbl_data[$i]['status'] != 'Allocated') { ?>
															<a class="green" href="<?php echo SURL . "app/Vehicle_coding/edit/" . $id ?>">
																<i class="ace-icon fa fa-pencil bigger-130"></i>
															</a>
															<a id="bootbox-confirm" href="javascript:void(0)" class="red" onClick="confirmDelete('<?php echo SURL; ?>app/Vehicle_coding/delete/<?php echo $tbl_data[$i]['id']; ?>');">
																<i class="ace-icon fa fa-trash-o bigger-130"></i>
															</a>
														<?php } else { ?>
															<span class="red bolder">Vehicle Is Allocated To A Trip</span>
														<?php } ?>
													</td>
													<?php
													?>
