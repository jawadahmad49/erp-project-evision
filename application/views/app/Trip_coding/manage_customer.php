								...
								<div class="col-xs-12">
									...
									<div class="clearfix">
										<div class="pull-right tableTools-container">
											<a href="<?php echo SURL ?>app/Trip_coding/add_rider">
									...
									<div>
										...
										<table id="dynamic-table" class="table table-striped table-bordered table-hover">
											...
											foreach ($trip_detail as $key => $value) {
												$count++;
												$id = $value['id'];
												$sp_name = $this->db->query("SELECT * FROM `tbl_sales_point` where sale_point_id='" . $value['sale_point_id'] . "'")->row_array()['sp_name'];
												$rider_name = $this->db->query("SELECT * FROM `tbl_rider_coding` where id='" . $value['rider_id'] . "'")->row_array()['rider_name'];
												$vehicle_number = $this->db->query("SELECT * FROM `tbl_vehicle_coding` where id='" . $value['vehicle_id'] . "'")->row_array()['vehicle_number'];
												...
												<tr>
													...
													<td>
														<?php echo $order_names; ?>
													</td>
													<td>
														<a class="green" href="<?php echo SURL . "app/Trip_coding/edit/" . $value['id'] ?>">
															<i class="ace-icon fa fa-pencil bigger-130"></i>
														</a>
														<?php if ($value['status'] == 'Pending') { ?>
															<a id="bootbox-confirm" href="javascript:void(0)" class="red" onClick="confirmDelete('<?php echo SURL; ?>app/Trip_coding/delete/<?php echo $value['id']; ?>');">
