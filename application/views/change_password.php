...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>LPG-Change Password</title>
									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												...
												Please Enter Reset Information
											</h4>
											 <?php
										    ...
										    //  ?>
										     	<!-- <div class="alert alert-danger"> <?php //echo $this->session->flashdata('logout'); ?> </div> -->
										     <?php
										    //  }
										     ?>
											 <?php
											...
											<div class="space-6"></div>
												...
												<form class="form-horizontal" role="form" id="login_id" action="<?php echo SURL."login/change_password"?>" method="post">

												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<label>Old password</label><input type="password" name="old_password" class="form-control" placeholder="Enter Old Password" />
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<label>New Password</label><input type="password" name="new_password" class="form-control" placeholder="Enter New Password" />
															<i class="ace-icon fa fa-lock"></i>
														</span>
													</label>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<label>Confirm Password</label><input type="password" name="con_password" class="form-control" placeholder="Enter Confirm Password" />
															<i class="ace-icon fa fa-lock"></i>
														</span>
													</label>													
													<div class="space"></div>
													...
													<div class="clearfix">
														<button  type="submit" name="change_password_btn" value="change_password_btn" class="width-35 pull-right btn btn-sm btn-primary">
